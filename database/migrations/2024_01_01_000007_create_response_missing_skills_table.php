<?php
// database/migrations/2024_01_01_000007_create_response_missing_skills_table.php
...
return new class extends Migration
{
    public function up()
    {
        Schema::create('response_missing_skills', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('response_missing_skills');
    }
};
